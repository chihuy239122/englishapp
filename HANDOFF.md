...
- Current curriculum handoff: D1 migrations `0003_curriculum_expansion.sql`, `0004_curriculum_levels.sql` and `0005_progress_matching.sql` are applied; source includes 4 practice modules/16 lessons, CEFR A1–C1 levels/15 units, transcript matching and review progress APIs. Latest source code commit is `7528163`.
